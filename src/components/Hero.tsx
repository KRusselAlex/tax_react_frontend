  ...
  return (
    <div>
      ...
      <section className="w-full flex items-center justify-center min-h-screen overflow-hidden bg-secondary">
        ...
        {/* <!-- Content --> */}
        <div className="relative z-10 container mx-auto px-4 text-center text-gray-800">
          <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            We Make{" "}
            <span className="relative whitespace-nowrap text-[#a3c3d6] dark:text-green-400">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
          ...
          >
            ...
            >
              ...
              <span className="relative z-10 pr-2">Ask an Audit</span>
            </a>
          </div>
        </div>
