...
const ErrorModal: React.FC<ErrorProps> = ({ onClick, errorMessage }) => {
  return (
    <div>
      <div className="fixed z-10 inset-0 overflow-y-auto" id="my-modal">
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div>
              <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-buttonHover">
                <svg
                  className="h-6 w-6 text-third"
