        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mb-4">
            <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
              <p className="text-base font-semibold uppercase tracking-wide text-buttonColor dark:text-blue-200">
                Contact
              </p>
            ...
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                ...
                <ul className="mb-6 md:mb-0">
                  <li className="flex">
                    <div className="flex h-10 w-10 items-center justify-center rounded bg-buttonColor text-gray-50">
                      <svg
